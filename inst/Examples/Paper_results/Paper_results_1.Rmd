...
for(eventnumber in 1:29){
  ...
  control.linramp = list(proxy=proxy,interval=interval_d18O,interval.unit="index",
  ...
  temp_d18O = linrampfitter(results,control.linramp)
  if(do.plot.rampfit){
    {
  ...
  control.transition_dating_dust=list(label="dust")
