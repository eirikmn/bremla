#' Optimal data window for abrupt warming transitions in the last glacial
#'
#' Data windows enclosing abrupt warming transitions found by optimization scheme to be used in linear ramp model fit. Also includes onset depth and dating given by Rasmussen et al. (2014).
#'
#'
#' @format A data.frame with 29 rows and 10 columns:
#' \describe{
#'   \item{ID}{The row in the \code{GISevents} dataset.}
#'   \item{onsetlabel}{Description of the event.}
#'   \item{NGRIP_depth_m}{Onset of transitino in NGRIP depth.}
#'   \item{GICC_age.yb2k}{Onset of transition in GICC05 age.}
