#' Capron transition onsets (d18O)
#'
#' Abrupt warmings observed in the d18O record of the NGRIP ice core. Taken from
...
#' \describe{
#'   \item{`NGRIP d18O`}{Name of the transition.}
