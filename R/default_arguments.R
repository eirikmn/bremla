...
#'  \item{\code{hyperprior}}{List corresponding to the \code{hyper} object in INLA's \code{f}
#'   function which specifies the priors of the hyperparameters. Default is \code{NULL}
