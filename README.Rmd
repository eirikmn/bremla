...
gg2 = gg2 + geom_segment(data=data.frame(depth=results$data$depth[tie_indexes],                                   median=results$simulation$summary_sync$median[tie_indexes]-ageref_tie,                         lower=x$simulation$summary_sync$lower[tie_indexes]-ageref_tie,
