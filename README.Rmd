...
gg2 = gg2 + geom_segment(data=data.frame(depth=x$data$depth[tie_indexes],                                          median=x$simulation$summary_sync$median[tie_indexes]-ageref_tie,                               lower=x$simulation$summary_sync$lower[tie_indexes]-ageref_tie,
